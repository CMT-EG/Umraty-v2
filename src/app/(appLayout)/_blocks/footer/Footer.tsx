...
import Logo from "@/global/assets/logo/Aletqan-Logo.png";
import { QuotesIcon } from "@/global/assets/svg/QuotesIcon";
import { SMSTrackingIcon } from "@/global/assets/svg/SMSTrackingIcon";
import mosqueImg from "@/global/assets/images/mosque.svg";
import FooterDisplay from "./_blocks/footerDisplay/FooterDisplay";
        ...
        <div className="relative z-10 py-10 w-full max-w-[1132px] flex sm:items-center items-start justify-between gap-5 min-[1050px]:flex-row flex-col">
          <div className="flex flex-col items-start">
            ...
            <p className="relative max-w-[417px] text-sm leading-[1.625rem] ms-5 mb-6">
              ...
              الرئيس في مدينة جدة ، في برج الإتقان سكوير ، وهي شركة سعودية
              متخصصة في تنظيم الرحلات السياحية والحاصلة على ترخيص وزارة السياحة
              وعلي ترخيص من وزارة الحج والعمرة، تتبع الشركة لمجموعة الإتقان التي
              تعمل في مجال خدمات الحج والعمرة منذ أكثر من أربعة وثلاثون عاماً.
