...
import serviceImg1 from "@/global/assets/images/service-1.jpg";
// import serviceImg2 from "@/global/assets/images/service-2.jpg";
// import serviceImg3 from "@/global/assets/images/service-3.jpg";

function ReservationItem({ className, bookingData, ...props }: any) {
  const { endDate, startDate, onPayBooking, handleDelete } = useReservationItem(
    { bookingData }
  );
